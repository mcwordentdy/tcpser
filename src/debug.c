...
/*****************************************************************************/
/* History:
 * 02Mar16 gwb changed trace_type and log_desc to const from unsigned in order
 *             to eliminate a compiler warning.
 *             Made other changes to eliminate warnings caused by -Wpointer-sign
 */

int log_level=0;
FILE* log_file;
int trace_flags=0;
const char* trace_type[9];  // cheesy, but I can't think of another o(1) way
const char* log_desc[LOG_TRACE+1];
