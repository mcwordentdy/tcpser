 ...
 * History:
 *
 * 20Jan14 gwb Added support for a specified ip address in ip_init_server_conn().
 *             This was done to support the expanded functionality of the "-p"
 *             command line option.
 *
 */
