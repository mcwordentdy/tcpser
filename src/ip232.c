...
/* History:
 *
 * 20Jan14 gwb Adjusted the call to ip_init_server_conn() to include a blank ip address.
 *             Because this code is using pipes, a named ip address serves no purpose.
 *
 */
...
int ip232_init_conn(modem_config *cfg)
{
    ...
    rc = ip_init_server_conn("", port); /* gwb */
